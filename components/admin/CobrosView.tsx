...
export const CobrosView: React.FC<CobrosViewProps> = ({ transactions, onAddTransaction, onToggleStatus, onUpdateTransaction }) => {
  ...
  const incomes = transactions.filter(t => t.type === 'INCOME' && INCOME_CATEGORIES.includes(t.category));

  // Chart Data: Only showing COBRADO transactions
  const chartData = INCOME_CATEGORIES.map(cat => ({
    name: cat,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const txData: Transaction = {
        ...
        description: `Cobro espacio: ${category}`,
        isPaid: isPaid === 'true',
        paymentMethod
    };
