...
export const ReservationsView: React.FC<ReservationsViewProps> = ({ reservations, onUpdateStatus, onDelete, onToggleAbono }) => {
  // Range State
  ...
  useEffect(() => {
    ...
    // Start strictly from today
    setStartDate(today.toISOString().split('T')[0]);
    
    // Default show 4 weeks (28 days)
    const future = new Date(today);
    future.setDate(future.getDate() + 27); // 27 because inclusive start = 28 total
